...
public class stageManager : MonoBehaviour
{
    ...
    void Start(){
        ...
        this.Stages.Add(new Stage { StartingRow = 20, BgColor = BG_YELLOW, NumberOfObstacles = 1, Description = "WATCH OUT FOR SPIKEY EYES!", MusicSpeed = 1.05f}); //1 Obstacle / row - Yellow 
